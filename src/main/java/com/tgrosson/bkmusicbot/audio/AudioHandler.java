 ...
 */
package com.tgrosson.bkmusicbot.audio;

import com.tgrosson.bkmusicbot.BKMusicBot;
import com.tgrosson.bkmusicbot.playlist.PlaylistLoader.Playlist;
...
import com.tgrosson.bkmusicbot.queue.FairQueue;
import com.tgrosson.bkmusicbot.settings.Settings;
import com.tgrosson.bkmusicbot.utils.FormatUtil;
...
public class AudioHandler extends AudioEventAdapter implements AudioSendHandler 
{
    ...
    public Message getNowPlaying(JDA jda)
    {
        if(isMusicPlaying(jda))
        {
            ...
            eb.setDescription((audioPlayer.isPaused() ? BKMusicBot.PAUSE_EMOJI : BKMusicBot.PLAY_EMOJI)
    ...
    public Message getNoMusicPlaying(JDA jda)
    {
        ...
        return new MessageBuilder()
                ...
                .setDescription(BKMusicBot.STOP_EMOJI+" "+FormatUtil.progressBar(-1)+" "+FormatUtil.volumeIcon(audioPlayer.getVolume()))
    ...
    public String getTopicFormat(JDA jda)
    {
        if(isMusicPlaying(jda))
        {
            ...
            return "**"+title+"** ["+(userid==0 ? "autoplay" : "<@"+userid+">")+"]"
                    + "\n" + (audioPlayer.isPaused() ? BKMusicBot.PAUSE_EMOJI : BKMusicBot.PLAY_EMOJI) + " "
                    + "[" + FormatUtil.formatTime(track.getDuration()) + "] "
                    + FormatUtil.volumeIcon(audioPlayer.getVolume());
        }
        else return "No music playing " + BKMusicBot.STOP_EMOJI + " " + FormatUtil.volumeIcon(audioPlayer.getVolume());
    }
