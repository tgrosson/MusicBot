 ...
 */
package com.tgrosson.bkmusicbot.utils;
...
public class OtherUtil
{
    ...
    public static Path getPath(String path)
    {
        ...
        if(path.toLowerCase().startsWith(WINDOWS_INVALID_PATH))
        {
            ...
            try
            {
                path = new File(BKMusicBot.class.getProtectionDomain().getCodeSource().getLocation().toURI()).getParentFile().getPath() + File.separator + filename;
            }
    ...
    {
        if(BKMusicBot.class.getPackage()!=null && BKMusicBot.class.getPackage().getImplementationVersion()!=null)
            return BKMusicBot.class.getPackage().getImplementationVersion();
        else
            return "UNKNOWN";
    }
